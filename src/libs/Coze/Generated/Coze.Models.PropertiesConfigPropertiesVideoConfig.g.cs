...
namespace Coze
{
    ...
    public sealed partial class PropertiesConfigPropertiesVideoConfig
    {
        ...
        /// </summary>
        [global::System.Text.Json.Serialization.JsonPropertyName("stream_video_type")]
        public string? StreamVideoType { get; set; }

        /// <summary>
        /// 视频帧过期时间，单位为s，默认值是1，[1, 10]
        /// </summary>
        [global::System.Text.Json.Serialization.JsonPropertyName("video_frame_expire_duration")]
        public int? VideoFrameExpireDuration { get; set; }

        /// <summary>
        /// 视频抽帧速率，默认值是1，[1, 24]
        /// </summary>
        [global::System.Text.Json.Serialization.JsonPropertyName("video_frame_rate")]
