...
namespace Coze
{
    ...
    public sealed partial class PublishDraftBotResponse
    {
        ...
        public global::Coze.PublishDraftBotData? Data { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PublishDraftBotResponse" /> class.
        /// </summary>
        /// <param name="code">
        /// 调用状态码。0 表示调用成功，其他值表示调用失败，你可以通过 msg 字段判断详细的错误原因。
        /// </param>
...
#endif
        public PublishDraftBotResponse(
            int code,
            string msg,
            global::Coze.PublishDraftBotData? data,
