...
namespace Coze
{
    public partial class CozeClient
    {
        ...
        private static readonly global::Coze.EndPointSecurityRequirement[] s_ChatV3AsStreamSecurityRequirements =
            new global::Coze.EndPointSecurityRequirement[]
        ...
        public async global::System.Collections.Generic.IAsyncEnumerable<global::Coze.ChatV3Response2> ChatV3AsStreamAsync(
                ...
                else
                {
                    await global::Coze.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                                ...
                                .Create(__stream).EnumerateAsync(__effectiveCancellationToken))
                            {
                                ...
                                var __streamedResponse = global::Coze.ChatV3Response2.FromJson(__content, JsonSerializerContext) ??
                                                       throw global::Coze.ApiException.Create(
                                                           statusCode: __response.StatusCode,
