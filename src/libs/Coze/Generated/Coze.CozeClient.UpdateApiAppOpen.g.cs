...
namespace Coze
{
    public partial class CozeClient
    {
        ...
        private static readonly global::Coze.AutoSDKServer[] s_UpdateApiAppOpenServers = new global::Coze.AutoSDKServer[]
        ...
        private static readonly global::Coze.EndPointSecurityRequirement s_UpdateApiAppOpenSecurityRequirement0 =
        ...
        private static readonly global::Coze.EndPointSecurityRequirement[] s_UpdateApiAppOpenSecurityRequirements =
            new global::Coze.EndPointSecurityRequirement[]
            {                s_UpdateApiAppOpenSecurityRequirement0,
            };
        partial void PrepareUpdateApiAppOpenArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string apiAppId,
            global::Coze.UpdateApiAppOpenRequest request);
        partial void PrepareUpdateApiAppOpenRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string apiAppId,
            global::Coze.UpdateApiAppOpenRequest request);
        partial void ProcessUpdateApiAppOpenResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUpdateApiAppOpenResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Coze.UpdateApiAppOpenResponse> UpdateApiAppOpenAsync(
            string apiAppId,
        ...
        {
            var __response = await UpdateApiAppOpenAsResponseAsync(
                apiAppId: apiAppId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Coze.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Coze.AutoSDKHttpResponse<global::Coze.UpdateApiAppOpenResponse>> UpdateApiAppOpenAsResponseAsync(
            string apiAppId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUpdateApiAppOpenArguments(
            ...
            var __authorizations = global::Coze.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UpdateApiAppOpenSecurityRequirements,
                operationName: "UpdateApiAppOpenAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Coze.PathBuilder(
                                path: $"/v1/api_apps/{apiAppId}",
                                baseUri: ResolveBaseUri(
                                servers: s_UpdateApiAppOpenServers,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Coze.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Coze.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "UpdateApiAppOpenAsync",
                                pathTemplate: "$\"/v1/api_apps/{apiAppId}\"",
                                httpMethod: "PUT",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUpdateApiAppOpenResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Coze.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUpdateApiAppOpenResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Coze.UpdateApiAppOpenResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Coze.AutoSDKHttpResponse<global::Coze.UpdateApiAppOpenResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Coze.UpdateApiAppOpenResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Coze.UpdateApiAppOpenResponse> UpdateApiAppOpenAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Coze.UpdateApiAppOpenRequest
            {
                CallbackUrl = callbackUrl,
                Name = name,
            };

            return await UpdateApiAppOpenAsync(
                apiAppId: apiAppId,
                request: __request,
                requestOptions: requestOptions,
