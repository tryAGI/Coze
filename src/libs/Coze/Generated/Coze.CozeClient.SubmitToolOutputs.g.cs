...
namespace Coze
{
    public partial class CozeClient
    {
        ...
        private static readonly global::Coze.AutoSDKServer[] s_SubmitToolOutputsServers = new global::Coze.AutoSDKServer[]
        ...
        private static readonly global::Coze.EndPointSecurityRequirement s_SubmitToolOutputsSecurityRequirement0 =
        ...
        private static readonly global::Coze.EndPointSecurityRequirement[] s_SubmitToolOutputsSecurityRequirements =
            new global::Coze.EndPointSecurityRequirement[]
            {                s_SubmitToolOutputsSecurityRequirement0,
            };
        partial void PrepareSubmitToolOutputsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string conversationId,
            ref string chatId,
            global::Coze.SubmitToolOutputsRequest request);
        partial void PrepareSubmitToolOutputsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string conversationId,
            string chatId,
            global::Coze.SubmitToolOutputsRequest request);
        partial void ProcessSubmitToolOutputsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessSubmitToolOutputsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Coze.SubmitToolOutputsResponse> SubmitToolOutputsAsync(
            string conversationId,
            string chatId,
        ...
        {
            var __response = await SubmitToolOutputsAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Coze.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Coze.AutoSDKHttpResponse<global::Coze.SubmitToolOutputsResponse>> SubmitToolOutputsAsResponseAsync(
            string conversationId,
            string chatId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareSubmitToolOutputsArguments(
            ...
            var __authorizations = global::Coze.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_SubmitToolOutputsSecurityRequirements,
                operationName: "SubmitToolOutputsAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Coze.PathBuilder(
                                ...
                                servers: s_SubmitToolOutputsServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareSubmitToolOutputsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Coze.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Coze.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "SubmitToolOutputsAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessSubmitToolOutputsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Coze.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessSubmitToolOutputsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Coze.SubmitToolOutputsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Coze.AutoSDKHttpResponse<global::Coze.SubmitToolOutputsResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Coze.SubmitToolOutputsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Coze.SubmitToolOutputsResponse> SubmitToolOutputsAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Coze.SubmitToolOutputsRequest
            {
                Stream = false,
                ToolOutputs = toolOutputs,
            };

            return await SubmitToolOutputsAsync(
                conversationId: conversationId,
                chatId: chatId,
                request: __request,
                requestOptions: requestOptions,
