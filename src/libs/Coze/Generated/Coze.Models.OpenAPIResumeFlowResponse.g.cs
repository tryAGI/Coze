...
namespace Coze
{
    ...
    public sealed partial class OpenAPIResumeFlowResponse
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OpenAPIResumeFlowResponse" /> class.
        /// </summary>
        /// <param name="code">
        /// 调用状态码。0 表示调用成功，其他值表示调用失败，你可以通过 msg 字段判断详细的错误原因。
        /// </param>
...
#endif
        public OpenAPIResumeFlowResponse(
            int code,
            string? data,
            string? debugUrl,
            global::Coze.ResponseDetail? detail,
            string? executeId,
            global::Coze.Interrupt? interruptData,
            string? msg,
            global::Coze.Usage1? usage)
        {
            this.Code = code;
            this.Data = data;
