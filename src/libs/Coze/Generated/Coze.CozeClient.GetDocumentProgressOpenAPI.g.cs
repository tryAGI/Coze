...
namespace Coze
{
    public partial class CozeClient
    {
        ...
        private static readonly global::Coze.AutoSDKServer[] s_GetDocumentProgressOpenAPIServers = new global::Coze.AutoSDKServer[]
        ...
        partial void PrepareGetDocumentProgressOpenAPIArguments(
            ...
            ref global::Coze.GetDocumentProgressOpenAPIAgwJsConv agwJsConv,
            global::Coze.GetDocumentProgressOpenAPIRequest request);
        partial void PrepareGetDocumentProgressOpenAPIRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string datasetId,
            global::Coze.GetDocumentProgressOpenAPIAgwJsConv agwJsConv,
            global::Coze.GetDocumentProgressOpenAPIRequest request);
        partial void ProcessGetDocumentProgressOpenAPIResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetDocumentProgressOpenAPIResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Coze.GetDocumentProgressOpenAPIResponse> GetDocumentProgressOpenAPIAsync(
            string datasetId,
            global::Coze.GetDocumentProgressOpenAPIAgwJsConv agwJsConv,
        ...
        {
            var __response = await GetDocumentProgressOpenAPIAsResponseAsync(
                datasetId: datasetId,
                agwJsConv: agwJsConv,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Coze.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Coze.AutoSDKHttpResponse<global::Coze.GetDocumentProgressOpenAPIResponse>> GetDocumentProgressOpenAPIAsResponseAsync(
            string datasetId,
            global::Coze.GetDocumentProgressOpenAPIAgwJsConv agwJsConv,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareGetDocumentProgressOpenAPIArguments(
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Coze.PathBuilder(
                                ...
                                servers: s_GetDocumentProgressOpenAPIServers,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Coze.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Coze.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetDocumentProgressOpenAPIAsync",
                                pathTemplate: "$\"/v1/datasets/{datasetId}/process\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetDocumentProgressOpenAPIResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Coze.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetDocumentProgressOpenAPIResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Coze.GetDocumentProgressOpenAPIResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Coze.AutoSDKHttpResponse<global::Coze.GetDocumentProgressOpenAPIResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Coze.GetDocumentProgressOpenAPIResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Coze.GetDocumentProgressOpenAPIResponse> GetDocumentProgressOpenAPIAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Coze.GetDocumentProgressOpenAPIRequest
            {
                DocumentIds = documentIds,
            };

            return await GetDocumentProgressOpenAPIAsync(
                datasetId: datasetId,
                agwJsConv: agwJsConv,
                request: __request,
                requestOptions: requestOptions,
