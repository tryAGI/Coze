...
namespace Coze
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Coze.AutoSDKRetryOptions Retry { get; set; } = new global::Coze.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Coze.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Coze.IAutoSDKHook>();
        ...
        public global::Coze.AutoSDKClientOptions AddHook(
            global::Coze.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Coze.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Coze.AutoSDKClientOptions UseAuthorizationProvider(
            global::Coze.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Coze.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Coze.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Coze.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Coze.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Coze.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Coze.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Coze.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Coze.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Coze.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Coze.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Coze.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Coze.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Coze.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Coze.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Coze.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Coze.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Coze.AutoSDKClientOptions clientOptions,
            global::Coze.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Coze.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Coze.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Coze.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Coze.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Coze.IAutoSDKHook, global::Coze.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Coze.AutoSDKHookContext context)
        {
