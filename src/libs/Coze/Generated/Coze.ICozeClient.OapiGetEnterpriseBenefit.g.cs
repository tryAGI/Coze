...
namespace Coze
{
    public partial interface ICozeClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Coze.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Coze.AutoSDKHttpResponse<global::Coze.OapiGetEnterpriseBenefitResponse>> OapiGetEnterpriseBenefitAsResponseAsync(
            global::System.Collections.Generic.IList<string>? benefitTypeList = default,
            string? resourceId = default,
            global::Coze.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default);
