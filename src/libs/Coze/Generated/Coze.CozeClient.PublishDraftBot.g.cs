...
namespace Coze
{
    public partial class CozeClient
    {
        ...
        private static readonly global::Coze.AutoSDKServer[] s_PublishDraftBotServers = new global::Coze.AutoSDKServer[]
        ...
        private static readonly global::Coze.EndPointSecurityRequirement s_PublishDraftBotSecurityRequirement0 =
        ...
        private static readonly global::Coze.EndPointSecurityRequirement[] s_PublishDraftBotSecurityRequirements =
            new global::Coze.EndPointSecurityRequirement[]
            {                s_PublishDraftBotSecurityRequirement0,
            };
        partial void PreparePublishDraftBotArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Coze.PublishDraftBotRequest request);
        partial void PreparePublishDraftBotRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Coze.PublishDraftBotRequest request);
        partial void ProcessPublishDraftBotResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPublishDraftBotResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Coze.PublishDraftBotResponse> PublishDraftBotAsync(

            global::Coze.PublishDraftBotRequest request,
            global::Coze.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await PublishDraftBotAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Coze.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Coze.AutoSDKHttpResponse<global::Coze.PublishDraftBotResponse>> PublishDraftBotAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PreparePublishDraftBotArguments(
            ...
            var __authorizations = global::Coze.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PublishDraftBotSecurityRequirements,
                operationName: "PublishDraftBotAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Coze.PathBuilder(
                                ...
                                servers: s_PublishDraftBotServers,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Coze.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Coze.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "PublishDraftBotAsync",
                                pathTemplate: "\"/v1/bot/publish\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessPublishDraftBotResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Coze.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPublishDraftBotResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Coze.PublishDraftBotResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Coze.AutoSDKHttpResponse<global::Coze.PublishDraftBotResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Coze.PublishDraftBotResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Coze.PublishDraftBotResponse> PublishDraftBotAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Coze.PublishDraftBotRequest
            {
                BotId = botId,
            ...
            return await PublishDraftBotAsync(
                request: __request,
                requestOptions: requestOptions,
