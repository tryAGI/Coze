...
namespace Coze
{
    public partial class CozeClient
    {
        ...
        private static readonly global::Coze.AutoSDKServer[] s_OpenAPIUnpublishBotServers = new global::Coze.AutoSDKServer[]
        ...
        private static readonly global::Coze.EndPointSecurityRequirement s_OpenAPIUnpublishBotSecurityRequirement0 =
        ...
        private static readonly global::Coze.EndPointSecurityRequirement[] s_OpenAPIUnpublishBotSecurityRequirements =
            new global::Coze.EndPointSecurityRequirement[]
            {                s_OpenAPIUnpublishBotSecurityRequirement0,
            };
        partial void PrepareOpenAPIUnpublishBotArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string botId,
            global::Coze.OpenAPIUnpublishBotRequest request);
        partial void PrepareOpenAPIUnpublishBotRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string botId,
            global::Coze.OpenAPIUnpublishBotRequest request);
        partial void ProcessOpenAPIUnpublishBotResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessOpenAPIUnpublishBotResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Coze.OpenAPIUnpublishBotResponse> OpenAPIUnpublishBotAsync(
            string botId,
        ...
        {
            var __response = await OpenAPIUnpublishBotAsResponseAsync(
                botId: botId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Coze.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Coze.AutoSDKHttpResponse<global::Coze.OpenAPIUnpublishBotResponse>> OpenAPIUnpublishBotAsResponseAsync(
            string botId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareOpenAPIUnpublishBotArguments(
            ...
            var __authorizations = global::Coze.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_OpenAPIUnpublishBotSecurityRequirements,
                operationName: "OpenAPIUnpublishBotAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Coze.PathBuilder(
                                ...
                                servers: s_OpenAPIUnpublishBotServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareOpenAPIUnpublishBotRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Coze.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Coze.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "OpenAPIUnpublishBotAsync",
                                pathTemplate: "$\"/v1/bots/{botId}/unpublish\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessOpenAPIUnpublishBotResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Coze.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessOpenAPIUnpublishBotResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Coze.OpenAPIUnpublishBotResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Coze.AutoSDKHttpResponse<global::Coze.OpenAPIUnpublishBotResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Coze.OpenAPIUnpublishBotResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Coze.OpenAPIUnpublishBotResponse> OpenAPIUnpublishBotAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Coze.OpenAPIUnpublishBotRequest
            {
                ConnectorId = connectorId,
                UnpublishReason = unpublishReason,
            };

            return await OpenAPIUnpublishBotAsync(
                botId: botId,
                request: __request,
                requestOptions: requestOptions,
