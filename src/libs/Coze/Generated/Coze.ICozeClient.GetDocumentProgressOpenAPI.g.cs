...
namespace Coze
{
    public partial interface ICozeClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Coze.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Coze.AutoSDKHttpResponse<global::Coze.GetDocumentProgressOpenAPIResponse>> GetDocumentProgressOpenAPIAsResponseAsync(
            string datasetId,
            global::Coze.GetDocumentProgressOpenAPIAgwJsConv agwJsConv,
