...
namespace Coze
{
    public partial interface ICozeClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Coze.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Coze.AutoSDKHttpResponse<global::Coze.OpenAPIUpdateEnterpriseMemberResponse>> OpenAPIUpdateEnterpriseMemberAsResponseAsync(
            string enterpriseId,
            string userId,
