...
namespace Coze
{
    public partial class CozeClient
    {
        ...
        private static readonly global::Coze.AutoSDKServer[] s_OpenAPIResumeFlowServers = new global::Coze.AutoSDKServer[]
        ...
        private static readonly global::Coze.EndPointSecurityRequirement s_OpenAPIResumeFlowSecurityRequirement0 =
        ...
        private static readonly global::Coze.EndPointSecurityRequirement[] s_OpenAPIResumeFlowSecurityRequirements =
            new global::Coze.EndPointSecurityRequirement[]
            {                s_OpenAPIResumeFlowSecurityRequirement0,
            };
        partial void PrepareOpenAPIResumeFlowArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Coze.OpenAPIResumeFlowRequest request);
        ...
        public async global::System.Threading.Tasks.Task<global::Coze.OpenAPIResumeFlowResponse> OpenAPIResumeFlowAsync(

            global::Coze.OpenAPIResumeFlowRequest request,
            global::Coze.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await OpenAPIResumeFlowAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Coze.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Coze.AutoSDKHttpResponse<global::Coze.OpenAPIResumeFlowResponse>> OpenAPIResumeFlowAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Coze.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_OpenAPIResumeFlowSecurityRequirements,
                operationName: "OpenAPIResumeFlowAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Coze.PathBuilder(
                                ...
                                servers: s_OpenAPIResumeFlowServers,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Coze.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Coze.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "OpenAPIResumeFlowAsync",
                                pathTemplate: "\"/v1/workflows/resume\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::Coze.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Coze.OpenAPIResumeFlowResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Coze.AutoSDKHttpResponse<global::Coze.OpenAPIResumeFlowResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Coze.OpenAPIResumeFlowResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Coze.OpenAPIResumeFlowResponse> OpenAPIResumeFlowAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Coze.OpenAPIResumeFlowRequest
            {
                EventId = eventId,
