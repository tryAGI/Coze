...
namespace Coze
{
    public partial class CozeClient
    {
        ...
        private static readonly global::Coze.AutoSDKServer[] s_OpenAPIRemoveBotCollaboratorServers = new global::Coze.AutoSDKServer[]
        ...
        private static readonly global::Coze.EndPointSecurityRequirement s_OpenAPIRemoveBotCollaboratorSecurityRequirement0 =
        ...
        private static readonly global::Coze.EndPointSecurityRequirement[] s_OpenAPIRemoveBotCollaboratorSecurityRequirements =
            new global::Coze.EndPointSecurityRequirement[]
            {                s_OpenAPIRemoveBotCollaboratorSecurityRequirement0,
            };
        partial void PrepareOpenAPIRemoveBotCollaboratorArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string botId,
            ref string userId,
            object request);
        partial void PrepareOpenAPIRemoveBotCollaboratorRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string botId,
            string userId,
            object request);
        partial void ProcessOpenAPIRemoveBotCollaboratorResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessOpenAPIRemoveBotCollaboratorResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Coze.OpenAPIRemoveBotCollaboratorResponse> OpenAPIRemoveBotCollaboratorAsync(
            string botId,
            string userId,
        ...
        {
            var __response = await OpenAPIRemoveBotCollaboratorAsResponseAsync(
                botId: botId,
                userId: userId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Coze.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Coze.AutoSDKHttpResponse<global::Coze.OpenAPIRemoveBotCollaboratorResponse>> OpenAPIRemoveBotCollaboratorAsResponseAsync(
            string botId,
            string userId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareOpenAPIRemoveBotCollaboratorArguments(
            ...
            var __authorizations = global::Coze.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_OpenAPIRemoveBotCollaboratorSecurityRequirements,
                operationName: "OpenAPIRemoveBotCollaboratorAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Coze.PathBuilder(
                                path: $"/v1/bots/{botId}/collaborators/{userId}",
                                baseUri: ResolveBaseUri(
                                servers: s_OpenAPIRemoveBotCollaboratorServers,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Coze.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Coze.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "OpenAPIRemoveBotCollaboratorAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessOpenAPIRemoveBotCollaboratorResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Coze.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessOpenAPIRemoveBotCollaboratorResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Coze.OpenAPIRemoveBotCollaboratorResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Coze.AutoSDKHttpResponse<global::Coze.OpenAPIRemoveBotCollaboratorResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Coze.OpenAPIRemoveBotCollaboratorResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await OpenAPIRemoveBotCollaboratorAsync(
                botId: botId,
                userId: userId,
                request: __request,
                requestOptions: requestOptions,
